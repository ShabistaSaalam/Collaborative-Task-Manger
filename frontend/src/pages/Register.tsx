...
import { Loader2, Mail, Lock, User, CheckSquare } from 'lucide-react';
...
export default function Register() {
  ...
  const { register: registerUser, isAuthenticated, isLoading: authLoading, error, clearError } = useAuthStore();
